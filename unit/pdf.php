...
<page>
        ...
        <?php
         $mysqli= mysqli_connect("localhost","u8110790_db_pendaftaran","metalbset149","u8110790_db_pendaftaran");
        $no_pendaftaran = $_GET['no_pendaftaran'];
        $qupdate = "SELECT * FROM tb_pendaftaran WHERE no_pendaftaran = '$no_pendaftaran'";
...
<p></p>
		<table border="0" style="font-size: 16px; border-collapse: collapse; width: 100%;">
			...
			<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Nama Peserta </td><td>&nbsp; : &nbsp;</td><td><?php echo $dupdate['nama_siswa']; ?></td></tr>
			<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Asal Sekolah </td><td>&nbsp; : &nbsp;</td><td><?php echo$dupdate['asal_sekolah']; ?></td></tr>
		</table>
