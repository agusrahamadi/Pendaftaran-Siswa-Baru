...
<html lang="en">
    <head>    
        ...
        <meta charset="utf-8" />
        <title>MADRASAH ALIYAH NEGERI 2 HULU SUNGAI TENGAH</title>
        ...
        <!-- Favicon -->
        <link rel="shortcut icon" href="../gambar/backend/favicon.png" />
        <script type="text/javascript" src="../css/backend/chartjs/Chart.js"></script>
    </head>